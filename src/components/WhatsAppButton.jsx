...
const WhatsAppButton = ({ product }) => {
  ...
  return (
    <a 
      ...
      className="w-full py-3 px-4 bg-[#25D366] text-white rounded-xl font-semibold shadow-md hover:bg-[#1DA851] hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2 group"
    >
