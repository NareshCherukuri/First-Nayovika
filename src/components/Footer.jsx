...
const Footer = () => {
  return (
    <footer id="contact" className="mt-20 relative z-10">
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8 pb-8">
        <div className="bg-white/20 backdrop-blur-xl border border-white/60 shadow-[0_8px_32px_0_rgba(31,38,135,0.05)] rounded-3xl p-8 md:p-12 relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-center font-semibold tracking-wide w-full md:w-auto">
              ...
              <a href="https://instagram.com/nayovika" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto px-6 py-3 bg-white/40 hover:bg-white/60 border border-white/60 rounded-xl text-brand-maroon transition-all shadow-sm hover:shadow-md hover:-translate-y-1 flex justify-center items-center gap-2">
                Instagram
              </a>
